...
passport.use(new FacebookStrategy({
    ...
    'callbackURL': 'https://gengwuback.herokuapp.com/auth/facebook/callback',
...
passport.use(new GoogleStrategy({
        ...
        callbackURL: 'https://gengwuback.herokuapp.com/auth/google/callback'
    },
...
passport.use(new TwitterStrategy({
        ...
        callbackURL: 'https://gengwuback.herokuapp.com/auth/twitter/callback'
    },
...
function thirdPartyLogin(user, req, res) {
    ...
    User.find({
        ...
        if (items.length == 0) {
            ...
            return res.redirect('https://gengwufront.herokuapp.com/#/profile')
        }
    })
}
